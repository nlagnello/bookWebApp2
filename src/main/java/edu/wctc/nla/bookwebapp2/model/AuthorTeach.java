 ...
 * @author jlombardo
 */
public final class AuthorTeach {
    ...
    public AuthorTeach(Integer authorId) {
        this.authorId = authorId;
    }

    public AuthorTeach(Integer authorId, String authorName, Date dateAdded) {
        this.authorId = authorId;
    ...
    public boolean equals(Object obj) {
        ...
        final AuthorTeach other = (AuthorTeach) obj;
